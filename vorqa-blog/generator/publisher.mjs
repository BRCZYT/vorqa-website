...
<nav id="nav">
  <a href="../tr/" class="nav-logo">
    <img src="/brand_assets/vorqa_logo_main.png" alt="Vorqa Global" style="display:block;height:40px;width:auto;max-width:100%;object-fit:contain;flex-shrink:0">
  </a>
  <div class="nav-links">
